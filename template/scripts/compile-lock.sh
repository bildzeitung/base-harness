#!/bin/bash -e
#
# The SINGLE implementation of harness's lock-gen command. Every
...
#
# WHY THIS EXISTS: `uv pip compile` does
...
# the single source of truth for harness's target interpreter (do NOT
...
if ! command -v uv >/dev/null 2>&1; then
  ...
  echo "compile-lock.sh: requirements.lock." >&2
