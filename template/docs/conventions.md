...
<!-- Delete the examples below and replace them with your project's own fiats. They are here to show
     the expected shape: a rule, its exact scope, and where the line is. -->

## Example: one Screen or custom Widget per module
